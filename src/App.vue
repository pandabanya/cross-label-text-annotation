...
export default {
  ...
  data(){
    return {
      text: `<font>在一个遥远的</font>星球上，有一个名叫阿瓦隆的<strong>神秘岛屿</strong>，岛上居住着一群拥有超凡智慧的生物。他们拥有控制自然元素的能力，能够与风对话，与水共舞，甚至能够召唤雷电。然而，他们最珍贵的能力是预知未来。每当阿瓦隆的夜空中出现奇异的星象，他们就会聚集在古老的神庙前，通过古老的仪式来解读星辰的预言。
